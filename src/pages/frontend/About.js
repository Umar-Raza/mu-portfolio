        ...
        <div className="aboutCard">
          <div className="card">
            ...
            <div className="col-12 col-lg-6 aboutMeCol ">
              <h2 className='text-dark'>I am <span className='aboutName'> Muhammad Umar</span></h2>
              <p>
                A skilled Web and Mobile App Developer with <span className='specailWord'> expertise in JavaScript</span> , and expertise in Frameworks like <span className='specailWord '>React.js</span>  with one years of experience in the industry, I've had the Opportunity to work on a wide range of Projects, from simple Mobile Apps to complex web Applications.As a Developer, I thrive on tackling challenging problems and Collaborating with others to<span className='specailWord'> Create something Great</span> .  I'm always on the Lookout for new Challenges and Opportunities to expand my Skills and knowledge.If you're looking for a dedicated, experienced Developer who can help bring your Project to life, I'd love to hear from you! <span className='specailWord'>Please feel free</span> to contact me.
              </p>
                ...
                <Carousel responsive={responsive} infinite={true} className='skillSlider' >
                  ...
                  <div>
                    <SkillProgress
                      ...
                      percentageText={"50%"}
                    />
                    <h6>React Native  <br />coming soon</h6>
                  </div>
                </Carousel>
              </div>
            </div>
